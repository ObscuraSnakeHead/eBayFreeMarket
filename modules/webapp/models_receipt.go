...
type PaymentReceipt struct {
	...
	XMRPaymentResultItem *apis.XMRPaymentResult     `json:"xmr_payment_results,omitempty"`
	DOTPaymentResultItem *apis.DOTTransactionResult `json:"dot_payment_results,omitempty"`
}
...
func (i PaymentReceipt) XMRPaymentResult() ([]apis.XMRPaymentResult, error) {
	pr := []apis.XMRPaymentResult{}
	err := json.Unmarshal([]byte(i.SerializedData), &pr)
	return pr, err
}

func (i PaymentReceipt) DOTPaymentResult() (apis.DOTPaymentResult, error) {
	pr := apis.DOTPaymentResult{}
	err := json.Unmarshal([]byte(i.SerializedData), &pr)
	return pr, err
}

func (i PaymentReceipt) DOTEscrowMintResult() (apis.DOTEscrowMintResult, error) {
	pr := apis.DOTEscrowMintResult{}
	err := json.Unmarshal([]byte(i.SerializedData), &pr)
	return pr, err
}

func (i PaymentReceipt) DOTTransactionResult() (apis.DOTTransactionResult, error) {
	pr := apis.DOTTransactionResult{}
	err := json.Unmarshal([]byte(i.SerializedData), &pr)
	return pr, err
}

func (i PaymentReceipt) DOTCrowdloanMintResult() (apis.DOTCrowdloanMintResult, error) {
	pr := apis.DOTCrowdloanMintResult{}
	err := json.Unmarshal([]byte(i.SerializedData), &pr)
	return pr, err
}
...
func CreateXMRPaymentReceipt(transactionResult []apis.XMRPaymentResult) (PaymentReceipt, error) {
	txResultJSON, err := json.Marshal(transactionResult)
	if err != nil {
		return PaymentReceipt{}, err
	}
...
func CreateDOTEscrowReceipt(transactionResult []apis.DOTEscrowMintResult) (PaymentReceipt, error) {
	txResultJSON, err := json.Marshal(transactionResult)
	if err != nil {
		return PaymentReceipt{}, err
	}
...
func CreateDOTTransactionReceiptForTransaction(transactionResult apis.DOTTransactionResult) (PaymentReceipt, error) {
	txResultJSON, err := json.Marshal(transactionResult)
	if err != nil {
		return PaymentReceipt{}, err
	}
...
func CreateDOTTransactionReceiptForPayment(transactionResult apis.DOTPaymentResult) (PaymentReceipt, error) {
	txResultJSON, err := json.Marshal(transactionResult)
	if err != nil {
		return PaymentReceipt{}, err
	}
...
func CreateDOTTransactionReceiptForCrowdloanMint(mintResult apis.DOTCrowdloanMintResult) (PaymentReceipt, error) {
	txResultJSON, err := json.Marshal(mintResult)
	if err != nil {
		return PaymentReceipt{}, err
	}

	receipt := PaymentReceipt{
		Uuid:           mintResult.Hash,
		Type:           "polkadot-crowdloan-mint",
		SerializedData: string(txResultJSON),
	}
	return receipt, receipt.Save()
}
